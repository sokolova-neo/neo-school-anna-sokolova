module.exports = {
  ...
  MONGO_CONNECTION_STRING: 'mongodb://localhost:27017/rewardService?retryWrites=true',
  LOG_LEVEL: 'DEBUG',
  ...
  SNS_ARN: 'arn:aws:sns:ca-central-1:000000000000:reward-service',
  SNS_ARN_ENV: undefined,

  // CONSUMERS
  EVENT_CONSUMERS_ENABLED: true,
  SQS_URL: 'http://localhost:4566/000000000000/reward-service',
};
